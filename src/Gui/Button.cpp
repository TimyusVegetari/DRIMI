...
void drimi::Gui::Button::SetPosition ( GLfloat fX, GLfloat fY ) {
	sf::FloatRect sfBounds = m_sfNormalSprite.getLocalBounds ();
  m_sfNormalSprite.setOrigin (sf::Vector2f (sfBounds.width / 2.f, sfBounds.height / 2.f));
	m_sfNormalSprite.setPosition (fX, fY);
  m_sfSelectedSprite.setOrigin (sf::Vector2f (sfBounds.width / 2.f, sfBounds.height / 2.f));
	m_sfSelectedSprite.setPosition (fX, fY);
  m_sfPressedSprite.setOrigin (sf::Vector2f (sfBounds.width / 2.f, sfBounds.height / 2.f));
